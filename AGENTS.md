...
# FISH_CUE_TAGGER_MODEL=deepseek/deepseek-v4.1-flash # cheap/fast default (not :free roulette); provider order Together then DeepInfra, fallbacks allowed
# FISH_CUE_TAGGER_TIMEOUT_MS=40000 # unused as a pass cutoff; each chunk aborts at 12s and retries once
# FISH_CUE_TAGGER_CONCURRENCY=14 # in-flight chunks for one book
# FISH_CUE_TAGGER_GLOBAL_CONCURRENCY=24 # in-flight chunks across books on the worker

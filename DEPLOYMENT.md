...
TTS_POLL_NUDGE_BUDGET_MS=8000    # 0 once cron runs frequently
...
| Jobs sit at `queued` | Cron not firing (plan limits) or `CRON_SECRET` mismatch; check `TTS_POLL_NUDGE_BUDGET_MS` |

...
# FISH_CUE_TAGGER_MODEL=deepseek/deepseek-v4.1-flash  # cheap/fast default (not :free roulette); OpenRouter still pins provider to DeepSeek
# FISH_CUE_TAGGER_TIMEOUT_MS=40000          # whole-pass max; clamp 1s–120s
# FISH_CUE_TAGGER=0

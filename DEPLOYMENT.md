...
# FISH_CUE_TAGGER_MODEL=openai/gpt-oss-20b  # cheap default; worker may use nvidia/nemotron-3.5-lightning:free
# FISH_CUE_TAGGER_TIMEOUT_MS=40000          # one-shot max; clamp 1s–120s
# FISH_CUE_TAGGER=0

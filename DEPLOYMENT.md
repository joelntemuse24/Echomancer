...
OPENROUTER_API_KEY=...           # Also copy onto the VM worker for Whole-book cue tagging (Fish / Edge / Google)
FISH_API_KEY=...                 # Clones, Live Listen, direct Fish take-home
# FISH_CUE_TAGGER_MODEL=deepseek/deepseek-v4.1-flash  # cheap/fast default (not :free roulette); Together then DeepInfra, fallbacks allowed
# FISH_CUE_TAGGER_TIMEOUT_MS=40000          # not a pass cutoff; each chunk aborts at 12s
# FISH_CUE_TAGGER_CONCURRENCY=14
# FISH_CUE_TAGGER_GLOBAL_CONCURRENCY=24
# FISH_CUE_TAGGER=0

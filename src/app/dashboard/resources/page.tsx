        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4 text-sm">
            {[
              ...
              { q: "What voice models are used?", a: "We use F5-TTS with an AI Director that analyzes text to adjust pacing and emotion dynamically, creating natural-sounding narration." },
